...
exports.loading = {
    start: (callback = () => {}) => {
        ...
        setTimeout(() => {  // Loading Time out
            ...
            loadingLayer.classList.remove("veri-loading");
            loadingLayer.classList.add("veri-largeRefresh");
        }, 20000);
    },
    end: (callback = () => {}) => {
        // Remove Loading Layer
        disappear(document.getElementById("veri-loadingLayer"),callback);
    }
};