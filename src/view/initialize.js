    ...
    * */
    ...
    function loadedCheck() {
        if (numberOfLoaded === 0) { // If non of the picture has already loaded.
            ...
            loading.end(() => {  // Stop loading
                document.getElementById("veri-frame").appendChild(fragment);
                callback(null);
            });
        }
    }
